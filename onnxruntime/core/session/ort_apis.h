...
ORT_API_STATUS_IMPL(CreateNvProviderOptions, _Outptr_ OrtNvProviderOptions** out);
ORT_API_STATUS_IMPL(UpdateNvProviderOptions, _Inout_ OrtNvProviderOptions* nv_options,
                        _In_reads_(num_keys) const char* const* provider_options_keys,
                        _In_reads_(num_keys) const char* const* provider_options_values,
                        size_t num_keys);
ORT_API_STATUS_IMPL(GetNvProviderOptionsAsString, _In_ const OrtNvProviderOptions* nv_options, _Inout_ OrtAllocator* allocator, _Outptr_ char** ptr);
ORT_API(void, ReleaseNvProviderOptions, _Frees_ptr_opt_ OrtNvProviderOptions*);
ORT_API_STATUS_IMPL(UpdateNvProviderOptionsWithValue, _Inout_ OrtNvProviderOptions* nv_options, _In_ const char* key, _In_ void* value);
ORT_API_STATUS_IMPL(GetNvProviderOptionsByName, _In_ const OrtNvProviderOptions* nv_options, _In_ const char* key, _Outptr_ void** ptr);
}  // namespace OrtApis
